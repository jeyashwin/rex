...
class CreateLoanOfficer extends Component {
    render() {
        return ( 
            <div> 
            <CreateLoanOfficerPage>  
             ...
             {/* <div className="regular-container w-50 mx-auto">
                 ...
                 <div className="signInAbout box-about-intro col-md-5 mx-auto" style={{width: '400px'}}>
                        <form class="px-4 py-3">
                            ...
                            <div class="form-group">
                                <label for="exampleDropdownFormLicense1">
                                    License number
                                </label>
                                <input 
                                    type="License" 
                                    class="form-control" 
                                    id="exampleDropdownFormLicense1" 
                                    placeholder="#########"
                                />
                            </div>
                            <div class="form-group">
                                <label for="exampleDropdownFormCompany1">
                                    Company name
                                </label>
                                <input 
                                    type="Company" 
                                    class="form-control" 
                                    id="exampleDropdownFormCompany1" 
                                    placeholder="Company name"
                                />
                            </div>
                            <div class="form-group">
                                <label for="exampleDropdownFormState1">
                                    State
                                </label>
                                <input 
                                    type="Company" 
                                    class="form-control" 
                                    id="exampleDropdownFormState1" 
...
const CreateLoanOfficerPage = styled.div`
.signInAbout {
    margin-top: 3rem;
    margin-bottom: 5rem;
    position: relative;
