        ...
        <div class="jumbotron jumbotron-fluid">
          <div class="container">
            ...
            <div class="alert alert-danger m-left" role="alert">
              Due Dilligence Payment Missing, Please Submit
            </div>
            <div class="alert alert-danger m-left" role="alert">
              Residential Property Disclosures, Please Submit
            </div>
            <hr class="my-4" />
            <h5 class="progressTrackerType">Messeges</h5>
            <div class="alert alert-primary m-left" role="alert">
              Home Inpsection has been scheduled
            </div>
            <div class="alert alert-primary m-left" role="alert">
              Offer to Purchase, has been updated
            </div>
          </div>
        </div>
